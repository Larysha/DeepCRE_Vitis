...
from vitis_cre.src.utils import make_absolute_path, load_input_files, get_filename_from_path, get_time_stamp
...
def generate_genomic_features(genome_file_name: str, annotation_file_name: str, 
    ...
    annotation_path = annotation_file_name if os.path.isfile(annotation_file_name) else make_absolute_path("gene_models", annotation_file_name, start_file=__file__)
    ...
    # Save results
    if output_name:
        output_dir = make_absolute_path("results", "genomic_features", start_file=__file__)
