# R Utilities for Vitis CRE moca_blue Project
# This file contains reusable functions for project setup and common operations
# Source this file at the beginning of analysis scripts with: source("moca_blue/utils.R")
...
#' 
#' @param base_dir Character. Base directory for outputs (default: "results")
...
setup_output_directories <- function(base_dir = "results", 
                                   analysis_name, 
