...
default_blamm_dir <- "results/moca_blue/mo_proj/genomic_vitis_vinifera_PN40024_1000bp_pt0.0001"
...
ANNOTATION_FILE <- if (length(args) >= 5 && nzchar(args[5])) args[5] else "gene_models/vitis_vinifera_PN40024.gff3"
...
load_gene_annotations <- function(annotation_file) {
  ...
  gff_data <- read.table(annotation_file, header = FALSE, sep = "\t", 
