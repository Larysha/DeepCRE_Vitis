...
# File paths
default_input_go <- "gene_ontology/V_vinifera_ontology.gmt"
default_output_go <- "gene_ontology/V_vinifera_ont_converted.gmt"
default_genome_annotation <- "gene_models/vitis_vinifera_PN40024.gff3"
