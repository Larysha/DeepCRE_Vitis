...
# Default file paths for Vitis analysis - now uses enrichment analysis outputs
default_enrichment_results <- "results/moca_blue/mo_proj/20250825_vitis_motif_enrichment_results.csv"
default_integrated_data <- "results/moca_blue/mo_proj/20250825_vitis_motif_enrichment_integrated_data.csv"
default_analysis_state <- "results/moca_blue/mo_proj/20250825_vitis_motif_enrichment_analysis_state.rds"
