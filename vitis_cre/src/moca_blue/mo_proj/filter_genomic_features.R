...
# Default file paths
default_input_file <- "results/moca_blue/mo_proj/filtered_genomic_occurrences.txt"
default_output_dir <- "results/moca_blue/mo_proj"
default_tss_ranges <- "results/moca_blue/mo_range/vitisssr-TSS_motif_ranges_q1q9.csv"
default_tts_ranges <- "results/moca_blue/mo_range/vitisssr-TTS_motif_ranges_q1q9.csv"
default_annotation_file <- "gene_models/vitis_vinifera_PN40024.gff3"
...
# IMPORTANT: THESE EXCLUSIONS ARE SPECIFIC TO THE CURRENT TRAINING DATA
# chr00: Extra chromosome - model never trains on this, ALWAYS exclude
# chr19: Accidentally excluded from current training - TEMPORARY exclusion
#        TODO: REMOVE chr19 exclusion for future models that include it!
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
EXCLUDED_CHROMOSOMES <- c("chr00", "chr19")  # TODO: Remove chr19 for future models!
...
cat("  Total input occurrences (excluding chr00, chr19):", filtered_results$stats$input_count, "\n")
...
cat("  NOTE: chr00 (always excluded) and chr19 (temporarily excluded) filtered out\n")
