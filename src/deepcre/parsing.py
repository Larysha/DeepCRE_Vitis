...
class RunInfo:
    ...
    def load_chromosomes(self) -> None:
        ...
        for specie_info in self.species_info:
            ...
            path = chromosomes if os.path.isfile(chromosomes) else make_absolute_path("../../vitis_data/genome", chromosomes, start_file=__file__)
    ...
    def load_prediction_models(self) -> None:
        ...
        path = prediction_models if os.path.isfile(prediction_models) else make_absolute_path("../../out/saved_models", prediction_models, start_file=__file__)
...
class ParsedInputs:
    ...
    def parse(json_file_name: str, possible_general_parameters: Dict, possible_species_parameters: Dict, allow_multiple_species: bool = True, multiple_species_required_msr: bool = False) -> Tuple[ParsedInputs, List[Tuple[str, int, Exception]], int]:
        ...
        """
        json_file_name = json_file_name if os.path.isfile(json_file_name) else make_absolute_path(json_file_name, start_file=__file__)
        failed_parsings = []
