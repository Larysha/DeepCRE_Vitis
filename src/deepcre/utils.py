...
def combine_annotations(species_data: List[Dict[str, Any]], naming: str) -> str:
    ...
    output_dir_path = make_absolute_path("../../vitis_data", output_dir_name, start_file=__file__)
    os.makedirs(output_dir_path, exist_ok=True)
    save_path = make_absolute_path("../../vitis_data", output_dir_name, f"gtf_{naming}.csv", start_file=__file__)
...
def combine_tpms(species_data: List[Dict[str, Any]], naming: str) -> str:
    ...
    output_dir_path = make_absolute_path("../../vitis_data/tpm_counts", start_file=__file__)
    os.makedirs(output_dir_path, exist_ok=True)
...
def load_input_files(genome_file_name: str = "", annotation_file_name: str = "",
    ...
    if genome_file_name != "":
        try:    
            ...
            if os.path.isfile(genome_file_name):
                ...
                genome_path = make_absolute_path("../../vitis_data/genome", genome_file_name, start_file=__file__)
    ...
    if annotation_file_name != "":
        #see if given name is full path to file
        annotation_file_name = annotation_file_name if os.path.isfile(annotation_file_name) else make_absolute_path("../../vitis_data/gene_models", annotation_file_name, start_file=__file__)
    ...
    if tpm_counts_file_name != "":
        if os.path.isfile(tpm_counts_file_name):
            ...
            tpm_path = make_absolute_path("../../vitis_data/tpm_counts", tpm_counts_file_name, start_file=__file__)
